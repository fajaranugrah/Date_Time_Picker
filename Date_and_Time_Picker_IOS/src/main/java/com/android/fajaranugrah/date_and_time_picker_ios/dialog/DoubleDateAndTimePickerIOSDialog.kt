...
class DoubleDateAndTimePickerIOSDialog private constructor(
    context: Context,
    ...
    private var pickerTab0: DateAndTimePickerIOS? = null
    private var pickerTab1: DateAndTimePickerIOS? = null
    ...
    init {
        val layout =
            if (bottomSheet) R.layout.bottom_sheet_double_picker_bottom_sheet else R.layout.bottom_sheet_double_picker
        ...
        bottomSheetHelper.setListener(object : BottomSheetHelper.Listener {
            ...
            override fun onClose() {
                this@DoubleDateAndTimePickerIOSDialog.onClose()
            }
        })
    }
    ...
    private fun init(view: View?) {
        ...
        pickerTab0 = view.findViewById<View>(R.id.picker_tab_0) as DateAndTimePickerIOS
        pickerTab1 = view.findViewById<View>(R.id.picker_tab_1) as DateAndTimePickerIOS
        ...
        pickerTab0!!.setTodayText(todayText?.let { DateWithLabel(it, Date()) })
        pickerTab1!!.setTodayText(todayText?.let { DateWithLabel(it, Date()) })
        ...
        if (secondDateAfterFirst) {
            pickerTab0!!.addOnDateChangedListener(object : DateAndTimePickerIOS.OnDateChangedListener {
    ...
    private val tabsListDrawable: StateListDrawable
        private get() {
            ...
            colorState0.addState(
                intArrayOf(android.R.attr.state_selected),
                ColorDrawable(mainColor!!)
            )
            colorState0.addState(
                intArrayOf(-android.R.attr.state_selected), ColorDrawable(
                    backgroundColor!!
                )
            )
            return colorState0
    ...
    fun setTab0Text(tab0Text: String?): DoubleDateAndTimePickerIOSDialog {
        this.tab0Text = tab0Text
        return this
    }

    fun setTab1Text(tab1Text: String?): DoubleDateAndTimePickerIOSDialog {
        this.tab1Text = tab1Text
        return this
    }

    fun setButtonOkText(buttonOkText: String?): DoubleDateAndTimePickerIOSDialog {
        this.buttonOkText = buttonOkText
        return this
    }

    fun setTitle(title: String?): DoubleDateAndTimePickerIOSDialog {
        this.title = title
        return this
    }

    fun setTitleTextSize(titleTextSize: Int?): DoubleDateAndTimePickerIOSDialog {
        this.titleTextSize = titleTextSize
        return this
    }

    fun setBottomSheetHeight(bottomSheetHeight: Int?): DoubleDateAndTimePickerIOSDialog {
        this.bottomSheetHeight = bottomSheetHeight
        return this
    }

    fun setTodayText(todayText: String?): DoubleDateAndTimePickerIOSDialog {
        this.todayText = todayText
        return this
    }

    fun setListener(listener: Listener?): DoubleDateAndTimePickerIOSDialog {
        this.listener = listener
        return this
    }

    fun setCurved(curved: Boolean): DoubleDateAndTimePickerIOSDialog {
        this.curved = curved
        return this
    }

    fun setMinutesStep(minutesStep: Int): DoubleDateAndTimePickerIOSDialog {
        this.minutesStep = minutesStep
        return this
    }

    fun setMustBeOnFuture(mustBeOnFuture: Boolean): DoubleDateAndTimePickerIOSDialog {
        this.mustBeOnFuture = mustBeOnFuture
        return this
    }

    fun setMinDateRange(minDate: Date?): DoubleDateAndTimePickerIOSDialog {
        this.minDate = minDate
        return this
    }

    fun setMaxDateRange(maxDate: Date?): DoubleDateAndTimePickerIOSDialog {
        this.maxDate = maxDate
        return this
    }

    fun setDefaultDate(defaultDate: Date?): DoubleDateAndTimePickerIOSDialog {
        this.defaultDate = defaultDate
        return this
    }

    fun setDayFormatter(dayFormatter: SimpleDateFormat?): DoubleDateAndTimePickerIOSDialog {
        this.dayFormatter = dayFormatter
        return this
    }

    fun setCustomLocale(locale: Locale?): DoubleDateAndTimePickerIOSDialog {
        customLocale = locale
        return this
    }

    fun setTab0Date(tab0Date: Date?): DoubleDateAndTimePickerIOSDialog {
        this.tab0Date = tab0Date
        return this
    }

    fun setTab1Date(tab1Date: Date?): DoubleDateAndTimePickerIOSDialog {
        this.tab1Date = tab1Date
        return this
    }

    fun setSecondDateAfterFirst(secondDateAfterFirst: Boolean): DoubleDateAndTimePickerIOSDialog {
        this.secondDateAfterFirst = secondDateAfterFirst
        return this
    }

    fun setTab0DisplayDays(tab0Days: Boolean): DoubleDateAndTimePickerIOSDialog {
        this.tab0Days = tab0Days
        return this
    }

    fun setTab0DisplayHours(tab0Hours: Boolean): DoubleDateAndTimePickerIOSDialog {
        this.tab0Hours = tab0Hours
        return this
    }

    fun setTab0DisplayMinutes(tab0Minutes: Boolean): DoubleDateAndTimePickerIOSDialog {
        this.tab0Minutes = tab0Minutes
        return this
    }

    fun setTab1DisplayDays(tab1Days: Boolean): DoubleDateAndTimePickerIOSDialog {
        this.tab1Days = tab1Days
        return this
    }

    fun setTab1DisplayHours(tab1Hours: Boolean): DoubleDateAndTimePickerIOSDialog {
        this.tab1Hours = tab1Hours
        return this
    }

    fun setTab1DisplayMinutes(tab1Minutes: Boolean): DoubleDateAndTimePickerIOSDialog {
        this.tab1Minutes = tab1Minutes
        return this
    }

    fun setFocusable(focusable: Boolean): DoubleDateAndTimePickerIOSDialog {
        bottomSheetHelper.setFocusable(focusable)
        return this
    }

    private fun setTimeZone(timeZone: TimeZone?): DoubleDateAndTimePickerIOSDialog {
...
//        pickerTab1.setTimeZone(timeZone);
    ...
    override fun onClose() {
        ...
        if (listener != null && okClicked) {
            listener!!.onDateSelected(Arrays.asList(pickerTab0!!.date, pickerTab1!!.date))
        }
    }
    ...
    private val isTab0Visible: Boolean
        private get() = tab0!!.translationX == 0f
    ...
    class Builder(private val context: Context) {
        ...
        private var dialog: DoubleDateAndTimePickerIOSDialog? = null
        private var tab0Text: String? = null
        private var tab1Text: String? = null
        private var title: String? = null
        private var titleTextSize: Int? = null
        ...
        fun build(): DoubleDateAndTimePickerIOSDialog {
            val dialog = DoubleDateAndTimePickerIOSDialog(context, bottomSheet)
                .setTitle(title)
